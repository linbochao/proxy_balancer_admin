...
const columns = computed<Column[]>(() => [
  { prop: 'id', label: 'DeviceId' , width: 50 },
  { prop: 'name', label: 'UniqueId',  sortable: true, minWidth: 100 },
  { prop: 'host', label: 'Broker', minWidth: 100 },
  { prop: 'status', label: '状态', formatter: statusFormatter, minWidth: 100 },
  { prop: 'cpu', label: 'LatestClient', minWidth: 100 },
  { prop: 'memory', label: '最近在线', minWidth: 100 },
